...
-- Carrera
INSERT INTO test.LUSAX2.Carrera (CARRERA_CODIGO, [Circuito_id], CARRERA_CLIMA, CARRERA_CANT_VUELTAS,CARRERA_FECHA,CARRERA_TOTAL_CARRERA)
...
select distinct TELE_NEUMATICO1_NRO_SERIE,TELE_NEUMATICO1_POSICION,NULL,A.AUTO_ID
FROM GD1C2022.gd_esquema.Maestra M JOIN LUSAX2.Automovil A ON A.AUTO_NUMERO=M.AUTO_NUMERO AND A.AUTO_MODELO=M.AUTO_MODELO
...
UNION
select distinct TELE_NEUMATICO2_NRO_SERIE,TELE_NEUMATICO2_POSICION,NULL,A.AUTO_ID
FROM GD1C2022.gd_esquema.Maestra M JOIN LUSAX2.Automovil A ON A.AUTO_NUMERO=M.AUTO_NUMERO AND A.AUTO_MODELO=M.AUTO_MODELO
where TELE_NEUMATICO2_NRO_SERIE is not null AND TELE_NEUMATICO2_NRO_SERIE NOT IN (SELECT t.NEUMATICO_NRO_SERIE
																					FROM LUSAX2.TipoNeumatico t )
UNION
select distinct TELE_NEUMATICO3_NRO_SERIE,TELE_NEUMATICO3_POSICION,NULL,A.AUTO_ID
FROM GD1C2022.gd_esquema.Maestra M JOIN LUSAX2.Automovil A ON A.AUTO_NUMERO=M.AUTO_NUMERO AND A.AUTO_MODELO=M.AUTO_MODELO
where TELE_NEUMATICO3_NRO_SERIE is not null AND TELE_NEUMATICO3_NRO_SERIE NOT IN (SELECT t.NEUMATICO_NRO_SERIE
																					FROM LUSAX2.TipoNeumatico t )
UNION
select distinct TELE_NEUMATICO4_NRO_SERIE,TELE_NEUMATICO4_POSICION,NULL,A.AUTO_ID
FROM GD1C2022.gd_esquema.Maestra M JOIN LUSAX2.Automovil A ON A.AUTO_NUMERO=M.AUTO_NUMERO AND A.AUTO_MODELO=M.AUTO_MODELO
