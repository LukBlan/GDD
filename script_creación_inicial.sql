...
CREATE TABLE [LUSAX2].[CajaDeCambio] (
  ...
  CONSTRAINT PK_CAJA_ID PRIMARY KEY (CAJA_ID),
);
...
CREATE TABLE [LUSAX2].[Freno] (
  ...
  CONSTRAINT PK_FRENO_ID PRIMARY KEY (FRENO_ID),
);
...
ALTER TABLE [LUSAX2].[Automovil]
ADD CONSTRAINT FK_CAJA_ID
FOREIGN KEY (CAJA_ID) REFERENCES [LUSAX2].[CajaDeCambio](CAJA_ID);

ALTER TABLE [LUSAX2].[Automovil]
ADD CONSTRAINT FK_FRENO_ID
FOREIGN KEY (FRENO_ID) REFERENCES [LUSAX2].[Freno](FRENO_ID);
