...
ALTER TABLE [LUSAX2].[Telemetria_Neumatico]
ADD CONSTRAINT FKN_telemetria_id
FOREIGN KEY (telemetria_id) REFERENCES [LUSAX2].[Telemetria](telemetria_id);

ALTER TABLE [LUSAX2].[Telemetria_freno]
ADD CONSTRAINT FKF_telemetria_id
FOREIGN KEY (telemetria_id) REFERENCES [LUSAX2].[Telemetria](telemetria_id);
...
ALTER TABLE [LUSAX2].[Sector]
ADD CONSTRAINT FKS_CIRCUITO_CODIGO
FOREIGN KEY (CIRCUITO_CODIGO) REFERENCES [LUSAX2].[Circuito](CIRCUITO_CODIGO);
